...
<center>
	...
	<div id="content" class="w3-container">	
		<div id="namaContent" class="w3-container">
			<p style="float:left;" class="w3-xxlarge">Laporan Member Premium</p>
		</div>
		<div id="isi" class="w3-container">
			<table class="w3-table w3-bordered w3-border" style="width:100%;color:black;border:1px solid black;margin-top:1%;">
				<tr class="">
					<th>Nama Toko Premium</th>
					<th>Tanggal Mulai</th>
				...
				<?php
						...
						$sql = "SELECT * FROM tokoFisik WHERE membership = 1";
