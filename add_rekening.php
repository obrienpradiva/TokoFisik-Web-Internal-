	...
	<div id="content" class="w3-container">
		<div id="topContent" class="w3-container">
			<form method="POST" action="add_rekening.php">
				...
				<input class="asd w3-input w3-validate" type="number" placeholder="Nomor Rekening" name="noRek" required></input>
			...
			if(isset($_POST['nama']))
			{
					...
					$sql = "INSERT INTO `rekening`(`nomor_rekening`, `nama_pemilik`, `nama_bank`) VALUES
					('".$_POST['noRek']."','".$_POST['pemilik']."','".$_POST['nama']."')";
					$result = $mysqli->query($sql);
					if($result)
					{
						echo "<span style='color:white;' class='w3-card w3-teal'><b>Rekening Berhasil Ditambahkan</b></span>";
					}
					else
					{
						echo "<span style='color:white;' class='w3-card w3-red'><b>Error Inserting Rekening</b></span>";
					}
			}
			?>
		</div>
...
<script>
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyA3sCg_yWEv0uSmZ-S0zLyOuIt1cQ_lxCo",
    authDomain: "tosikws-101017.firebaseapp.com",
    databaseURL: "https://tosikws-101017.firebaseio.com",
    projectId: "tosikws-101017",
    storageBucket: "tosikws-101017.appspot.com",
    messagingSenderId: "292319961007"
  };
  firebase.initializeApp(config);
	...
	noTelpon = document.getElementById('noTelpon').value;
	alamat = document.getElementById('alamat').value;
		fb.child('customer/' + username).set({
		nama,
		username,
		password,
		email,
		...
		document.getElementById('Joko').innerHTML = username+" BANGSAT!";
	}
</script>